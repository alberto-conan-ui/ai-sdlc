...
description: "AI-Lore verb install — project the resolved set into an engine"
---

> Projected from `.ai-lore-ai-sdlc/memory/blueprint/verbs/core/lifecycle/install.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.

> **family:** lifecycle · **track:** full · **invoker:** human-lead · **writes:** engine-native artifacts (.claude/skills/, hooks, or the engine's equivalents) · **contracts:** golden-rule
...
- After [`upgrade`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/lifecycle/upgrade.verb.md), [`add-parent`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/outward/add-parent.verb.md) /
  [`remove-parent`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/outward/remove-parent.verb.md), or any change too broad for the
...
[`init`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/lifecycle/init.verb.md) precedes ·
[`add-verb`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/add-verb.verb.md)-family does per-artifact wiring incrementally ·
[`upgrade`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/lifecycle/upgrade.verb.md) and the parent verbs trigger re-runs.
