---
name: ai-lore-update-process
description: "AI-Lore verb update-process — amend an orchestration"
---

> Projected from `.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/update-process.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.

> **family:** blueprint · **track:** full · **writes:** blueprint/processes/<name>.process.md (outside core/); engine re-projection · **contracts:** golden-rule

# update-process

Amend a project-local or shadow process. Inherits
[`add-process`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/add-process.verb.md)'s encyclopedia — the verb-reference-only
...
- A step's verb was retired or renamed — the reference must move
  ([`retire-verb`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/retire-verb.verb.md) sends its dependents here).
...
[`add-process`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/add-process.verb.md) the encyclopedia ·
[`retire-process`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/retire-process.verb.md) the exit.
