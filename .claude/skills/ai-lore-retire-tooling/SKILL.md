---
name: ai-lore-retire-tooling
description: "AI-Lore verb retire-tooling — remove a registry card"
---

> Projected from `.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/retire-tooling.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.

> **family:** blueprint · **track:** full · **writes:** blueprint/tooling/<name>.tooling.md removed + index unwired · **contracts:** golden-rule
...
[`add-tooling`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/add-tooling.verb.md) · [`update-tooling`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/blueprint/update-tooling.verb.md).
