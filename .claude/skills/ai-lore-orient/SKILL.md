---
name: ai-lore-orient
description: "Session open — load the methodology, walk the focus chain, check for drift"
---
...
- **The methodology.** The five pillars are loaded: [`project-structure.md`](../../../.ai-lore-ai-sdlc/process/project-structure.md), [`memory.md`](../../../.ai-lore-ai-sdlc/process/memory.md), [`status.md`](../../../.ai-lore-ai-sdlc/process/status.md), [`verbs/verbs.index.md`](../../../.ai-lore-ai-sdlc/process/verbs/verbs.index.md), [`bindings.md`](../../../.ai-lore-ai-sdlc/process/bindings.md). On the plain-text path, `ai_readme.md` has just walked the session through them. On an installed engine, the SessionStart hook fires `orient` directly — the session reads the five files itself as its first step. Either way, by the time orient has finished, the session is AI-Lore-shaped.
...
[`project-structure.md`](../../../.ai-lore-ai-sdlc/process/project-structure.md) carries the full git arrangement.
