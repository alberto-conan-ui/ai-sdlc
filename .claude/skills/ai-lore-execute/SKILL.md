...
Executing is the **default posture** — the value `init` writes on home at project creation, and the value a new child track defaults to unless the Human Lead chooses otherwise.
