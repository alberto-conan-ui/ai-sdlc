---
name: ai-lore-groom
description: "AI-Lore process groom — the tidy-the-project sweep"
---

> Projected from `.ai-lore-ai-sdlc/memory/blueprint/processes/core/groom.process.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this process makes is confirmed with the Human Lead.

> **invoker:** human-lead · **composes:** review-focus-tree; integrate-notepad; review-backlog; review-mirror; review-references
...
[`ack`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/acknowledgement/ack.verb.md) is the natural coda — and if the journal's live window
has grown stale, offer [`archive-journal`](../../../.ai-lore-ai-sdlc/memory/blueprint/verbs/core/lifecycle/archive-journal.verb.md) as an
encore.
