...
- `TRACKING.md` — current mode, active goal, active phase
- `LESSONS_LEARNED.md` — both project-level and workstream-level
...
- `SESSION_LOG.md` — last entry, if you need detail on what happened
...
- Write `SPEC.md` — the problem, the vision, design principles.
...
- Write `PLAN.md` — the roadmap: phases with status, each referencing the active goal.
