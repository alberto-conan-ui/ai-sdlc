...
- The root index additionally includes **What This Is**, **Tech Stack**, **Repo Structure**, **Key Files**, alongside Sub-areas and Insights. See [conventions.md](../conventions.md) for the initial and full root templates.
