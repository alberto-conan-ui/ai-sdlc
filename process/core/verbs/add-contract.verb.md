...
- A note routed by [`integrate-notepad`](./integrate-notepad.verb.md) turns out to
  be a rule.
...
then what checks it (a hook, a walk at [`save-point`](./save-point.verb.md), a
reviewer's eye).
...
[`save-point`](./save-point.verb.md) walks the accumulated set ·
[`integrate-notepad`](./integrate-notepad.verb.md) feeds rules here.
