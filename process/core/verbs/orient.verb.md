...
longer exists is surfaced too — [`release-track`](./release-track.verb.md) is the
Human Lead's remedy.
...
[`mount-track`](./mount-track.verb.md) the write-capable follow-up ·
[`close-session`](./close-session.verb.md) the closing twin ·
[`release-track`](./release-track.verb.md) for stale mounts orient surfaces.
