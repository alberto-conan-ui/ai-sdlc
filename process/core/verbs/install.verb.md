...
- After [`upgrade`](./upgrade.verb.md), [`add-parent`](./add-parent.verb.md) /
  [`remove-parent`](./remove-parent.verb.md), or any change too broad for the
...
[`add-verb`](./add-verb.verb.md)-family does per-artifact wiring incrementally ·
