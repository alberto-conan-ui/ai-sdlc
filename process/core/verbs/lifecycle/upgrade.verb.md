...
[`retire-verb`](../blueprint/retire-verb.verb.md) restores the inherited artifact), changed
...
[`retire-verb`](../blueprint/retire-verb.verb.md)-family executes shadow fates ·
[`save-point`](../acknowledgement/save-point.verb.md) often follows an upgrade.
