...
| Route | Through |
|---|---|
| It's an inviolable rule | [`add-contract`](./add-contract.verb.md) (or `update-contract` when it sharpens one) |
| It describes the Payload's shape | [`update-mirror`](./update-mirror.verb.md) |
| It's an owned executable | [`add-tooling`](./add-tooling.verb.md) / `update-tooling` |
...
[`add-contract`](./add-contract.verb.md) · [`update-mirror`](./update-mirror.verb.md)
· [`add-tooling`](./add-tooling.verb.md) ·
