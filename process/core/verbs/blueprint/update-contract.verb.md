...
title: update-contract — sharpen an inviolable rule
family: blueprint
context: ./blueprint.md
track: full
invoker: human-lead
writes:
  - blueprint/contracts/<name>.contract.md (outside core/)
  - citation rewiring + hook update where checkable
contracts:
  - golden-rule
updated: 2026-07-02
---
...
is theirs to move. Inherits [`add-contract`](./add-contract.verb.md)'s encyclopedia.
...
[`add-contract`](./add-contract.verb.md) · [`retire-contract`](./retire-contract.verb.md).
