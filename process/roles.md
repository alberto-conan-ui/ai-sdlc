...
- **Memory responsibilities** — every role participates in the memory pipeline as defined in [memory.md](./memory.md): log entries, insight surfacing, journal writing, and loading relevant knowledge on session start
